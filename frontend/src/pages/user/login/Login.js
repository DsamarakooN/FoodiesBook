    ...
    useEffect(() => {
        setTimeout(() => {
            if (location.state?.error) {
                alert(location.state.error, {type: "error"});
            }
    ...
    return (
        <div className="login-container h-screen">
            <div className="login-content bg-gray-700">
                <h1 className="login-title">Login to FoodiesBook</h1>
                <SocialLogin/>
...
const LoginForm = () => {
    ...
    const handleSubmit = event => {
        ...
        login(loginRequest)
            .then(response => {
                ...
                alert("You're successfully logged in!", {type: "success"});
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-item">
                <button type="submit" className="btn btn-block btn-primary" id="logb">
                    Login
                </button>
            </div>
        </form>
